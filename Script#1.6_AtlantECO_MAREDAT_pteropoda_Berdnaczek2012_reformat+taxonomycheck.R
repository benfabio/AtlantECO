...
##### ATLANTECO SCRIPT 1.6 ----------------------------------------------------------------------------------------------------------------------------
##### 08/10/2021: R Script to reformat the MAREDAT Oceans ZooScan imaging data published by Berdnaczek et al. (2012) - ESSD © Fabio Benedetti, ETH Zürich, IBP, UP Group.
